...
checkoutBtn.addEventListener("click", function () {
  ...
  // enviar o pedido para api do whattapp
...
// verificar a hora e manipular o card no horário
function checkRestaurantOpen() {
  const data = new Date();
  const hora = data.getHours();
  return hora >= 18 && hora < 22; // True o restaurante está aberto
}
